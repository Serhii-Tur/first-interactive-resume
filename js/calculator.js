...
function calculateSum() {
    ...
    //values
    const websiteType = extractPriceFromValue(websiteTypeSelect.value);
    const technologieValue = getTechnologiesSum (technologiesMultiSelect.getValue());
    ...
    const totalSum = websiteType + technologieValue + websiteCartValue + websiteReceptionValue;
